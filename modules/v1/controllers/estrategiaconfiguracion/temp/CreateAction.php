...
class CreateAction extends Action
{
    ...
    public function run()
    {
        ...
        try {
            ...
            foreach ($requestParams['estrategia_id'] as $key => $value) {
                $model = new ResiduoUsuarioEstrategiasTempModel();
                $model->usuario_id = $requestParams['usuario_id'];
                $model->estrategia_id = $value;
